...
public class MvcControllerA {
   ...
   */
  @RequestMapping(value="/list", method = RequestMethod.GET)  //---- GET 방식의 경우 method를 생략할 수 있습니다.
  public String methodA() {
     ...
     * 2. prefix값을 반환값 앞에 추가하고 ,suffix 값을 반환값 뒤에 추가합니다.
  ...
  @RequestMapping(value = "/detail")  //---- value만 사용하는 경우 "value = " 생략할 수 있습니다.
  public void methodB() {
     ...
     * 2. ViewResolver는 prefix 값을 반환값 앞에 추가하고, suffix값을 반환값 뒤에 추가합니다.
     *       "/WEB-INF/views/" + "a/detail" + ".jsp"  ==> "/WEB-INF/views/a/detail.jsp"
     */
  }
  
  @RequestMapping("/b/c/d/regist")   // url 요청   // 요청 주소(/a/b/c/d/regist)와 프로젝트 내 경로(a/regist)를 다르게 설정하면 보안에 좋다
  public ModelAndView methodC() {
    ModelAndView mv = new ModelAndView();
    mv.setViewName("a/regist");      // 파일 경로
    return mv; 
